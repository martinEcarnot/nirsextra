...
#' 'msc'		Multi-scater Correction			ref :1 spectre  partir duquel est calcul la correction (dfaut= mean(Xi.d))#	'ma'		Moving average			wsz: taille de la fenetre glissante (dfaut=3)
